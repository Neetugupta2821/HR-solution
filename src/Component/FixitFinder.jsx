...
console.log(selectedJobTitle)
  const handleGetsearchData = () => {
    axios.post(`${baseUrl}fixit_finder`, {
  ...
  const handelFixiderCMS = () => {
    axios.get(`${baseUrl}getService/6605031c9a99e3c931fff841`).then((response) => {
    ...
    <div>
      <div>
            ...
            <div className="row justify-content-center">
              <div className="col-md-12 text-center">
                ...
                <div>
                  ...
                  <p className="para" dangerouslySetInnerHTML={renderHTML(findercms.Description)}>
        ...
        <div className="container pb-80">
          <Stack direction="row" spacing={2} className="my-5 mb-5" sx={{ m: 5 }}>
            ...
            <div className="col-md-12 col-sm-12 col-lg-4 Addmarginthree">
              <div className="section-bt FindJob">
                <button
                  ...
                  href="job-grid"
                >
                  Finder Here <i className="fi fi-sr-arrow-right" />
                </button>
              </div>
          ...
          {rows.length === 0 ? null : (<> <Box sx={{ m: 5 }}> <TableContainer component={Paper} style={{ overflowX: 'auto' }}>
