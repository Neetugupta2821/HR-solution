...
import contactus from '../Image/contactUs.webp'
...
export default function ContentAS() {
    ...
    return (
        <>
            <Header />
            <section className="gridBanner" style={{ backgroundImage: `url(${contactus})` }}>
                <div className="container-fluid">
                    <div className="row">
                        <div className="container">
                            <div className="row">
                                <h2>Contact Us </h2>
                                <p className='mt-2'> Do not hesitate to contact us for more information.</p>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div className="col-lg-6 col-md-6 wow slideInLeft col-sm-12">
                            <div className="bannnerleftContent ">
                                ...
                                <p className="bannerpara">
                                    Get in touch with us today and let's start transforming your business together.
                                </p>
                                <div className="mapIconParent">
                                    ...
                                    <div className="maptext">
                                        <h5>Call us</h5>
                                        <p className='mt-0'>Phone : +23272065065   +23288353535</p>
                                    </div>
                                </div>
                                <div className="mapIconParent">
                                    <div className="mapIcon">
                                    ...
                                    <div className="maptext">
                                        <h5>Email us</h5>
                                        <p className='mt-0'>info@smartstart.sl</p>
                                    </div>
                                </div>
                                <div className="mapIconParent">
                                    <div className="mapIcon">
                                    ...
                                    <div className="maptext">
                                        <h5>Head Office</h5>
                                        <p className='mt-0'>Head Office:1 Jangah Close, Main Peninsular Road, Baw Baw</p>
                                    </div>
                                </div>
                            </div>
                        </div>
