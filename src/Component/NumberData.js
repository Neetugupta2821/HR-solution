      ...
      <div className="col-lg-3 stats col-md-6 col-sm-6">
        <div className="parentCounter">
          ...
          <div>
            ...
            <Link to='/showjobs'> <h6>Active Jobs</h6></Link>
          </div>
        </div>
      </div>
      <div className="col-lg-3 stats col-md-6 col-sm-6">
        <div className="parentCounter">
          ...
          <div>
            ...
            <h6 onClick={handlenavigateacclients123} style={{"cursor":"pointer"}}>Available Candidate Profile</h6> 
          </div>
        </div>
      </div>
      <div className="col-lg-3 stats col-md-6 col-sm-6">
        <div className="parentCounter">
          ...
          <div>
            ...
            <Link to='/Signin'><h6>Elite Female Talent Pool</h6></Link>
          </div> 
        </div>
      </div>
      <div className="col-lg-3 stats col-md-6 col-sm-6">
        <div className="parentCounter">
          ...
          <div>
            ...
            <CountUp end={count.all_clients_count} />
            </div>
            <Link to="/ClientPortfolio"> <h6>Client Portfolio</h6></Link>
          </div>
        </div>
      </div>
    </div>
