...
import Background from "../Image/banner1.jpeg";
import img1 from "../Image/about-1.webp";
import img2 from "../Image/about-2.webp";
import img3 from "../Image/about-3.webp";
  ...
  return (
    <>
      <div className="aboutWrapper">
            ...
            <div className="row">
              ...
              <div className="col-lg-6">
                <div className="smartProfesion">
                  ...
                  >
                    <Link to='/showjobs'> <button className="b-btn job_area_btn" href=" ">
        ...
        <section className="specialFeature pt-80 pb-80">
          <div className="container">
            <div className="row">
