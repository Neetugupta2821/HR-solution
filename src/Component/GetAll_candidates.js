...
const GetAll_candidates = () => {
  ...
  const getdataformclient = () => {
    axios.get(`${baseUrl}getAll_candidates`).then((response) => {
                      ...
                      <MDBCol lg="4">
                        <MDBCard className="mb-4">
                          <MDBCardBody className="text-center">
                            ...
                            <p className="text-muted mb-2"> {item?.job_Heading}</p>
                            <p className="text-muted mb-2">{item?.HomeAddress} </p>
                          </MDBCardBody>
                        </MDBCard>
                      </MDBCol>
                        ...
                        <MDBCard className="mb-4">
                          <MDBCardBody>
                            <MDBRow>
                              ...
                              <MDBCol sm="9">
                                <MDBCardText className="text-muted">{item?.first_Name}</MDBCardText>
                              </MDBCol>
                            </MDBRow>
                            <hr />
                            <MDBRow>
